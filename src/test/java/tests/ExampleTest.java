...
public class ExampleTest extends PageObjects {
    ...
    public void tapOnNineOnCalculator() {
        extentReport.createParentTest("Tap On Calculator Digit Nine", "Tap on the Digit Nine in the Calculator app ");
    ...
    public void tapOnEightOnCalculator() {
        extentReport.createParentTest("Tap On Calculator Digit Eight", "Tap on the Digit Eight in the Calculator app ");
