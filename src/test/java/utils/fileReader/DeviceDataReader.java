...
public class DeviceDataReader {
    ...
    private static final String DEVICES_JSON_FILE_PATH = System.getProperty("user.dir") + "/src/test/resources/testDataFiles/devices.json"; // Update with the correct file path
    ...
    public static List<DeviceData> getDeviceData() throws FileNotFoundException {
        ...
        List<DeviceData> deviceDataList = gson.fromJson(new FileReader(jsonFile), new TypeToken<List<DeviceData>>() {
        }.getType());
